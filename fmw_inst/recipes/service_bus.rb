...
if ['12.2.1', '12.2.1.1', '12.2.1.2', '12.2.1.3', '12.2.1.4', '12.1.3'].include?(node['fmw']['version'])
  ...
  elsif node['fmw']['version'] == '12.2.1.4'
    fmw_installer_file = node['fmw']['tmp_dir'] + '/service_bus/fmw_12.2.1.4.0_osb.jar'
  end
...
if ['10.3.6', '12.1.3', '12.2.1', '12.2.1.1', '12.2.1.2', '12.2.1.3', '12.2.1.4'].include?(node['fmw']['version'])
